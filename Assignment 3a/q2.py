...
def convertToListFormat(dateString):
    dmy =[]
    if ('/' in dateString):
...
def getDifference(dateString1, dateString2):
    date1 = convertToListFormat(dateString1)
    date2 = convertToListFormat(dateString2)
    day1= int(date1[0])
    month1= int(date1[1])
    year1= int(date1[2])
    day2= int(date2[0])
...
result = getDifference(dateInput1,dateInput2)
